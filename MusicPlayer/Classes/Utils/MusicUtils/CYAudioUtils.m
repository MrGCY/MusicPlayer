...
NSString * const kNotificationAudioPlayFinish = @"kNotificationAudioPlayFinish";

@interface CYAudioUtils()<AVAudioPlayerDelegate>
/** 当前播放器对象 */
@property (nonatomic, strong) AVAudioPlayer * currentPlayer;

@end
@implementation CYAudioUtils
- (instancetype)init
{
    if (self = [super init]) {
        [self setupPlayer];
...
{
    if (flag) {
        [[NSNotificationCenter defaultCenter] postNotificationName:kNotificationAudioPlayFinish object:self.currentPlayer];
    }
}
@end
